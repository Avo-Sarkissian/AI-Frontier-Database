...
"Each bubble is one model FAMILY — the best-scoring variant, so five Claude Opus 5 effort tiers "
    ...
    'local': (
        ...
        "scores and this dashboard will not guess one. Speed is a "
        "bandwidth-bound estimate (±30%) for token generation, not prompt "
        "processing, and is an upper bound for MoE models. "
